...
void autopxd_entity(std::ofstream& out, const cppast::cpp_entity& e)
{
...
void autopxd_ast(std::ofstream& out, const cppast::cpp_file& file)
{
    // print file name
...
int main(int argc, char* argv[]) try
{
    ...
    else
    {
        ...
        auto file = parse_file(config, 
                               logger, options["file"].as<std::string>(),
